...
Examples:
  ...
  tui-designer preview --list     # List all flows
    ...
    parser.add_argument(
        "--version", action="version", version="TUI Form Designer 1.0.0"
    )
    ...
    validate_parser = subparsers.add_parser(
        "validate", help="Validate flow definitions"
    )
    validate_parser.add_argument("flows", nargs="*", help="Flow files to validate")
    validate_parser.add_argument(
        "--interactive", "-i", action="store_true", help="Interactive validation mode"
    )
    ...
    test_parser.add_argument(
        "--interactive", "-i", action="store_true", help="Interactive testing mode"
    )
    ...
    preview_parser.add_argument(
        "--list", "-l", action="store_true", help="List all flows"
    )
    preview_parser.add_argument(
        "--interactive", "-i", action="store_true", help="Interactive preview mode"
    )
    ...
    if not Path(flows_dir).exists() and args.command in [
        "design",
        "validate",
        "test",
        "preview",
