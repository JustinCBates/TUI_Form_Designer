...
class TestQuestionaryUI:
    ...
    def test_prompt(self, mock_text):
        ...
        mock_text.assert_called_once_with(
            "Enter text:", default="default", style=ui.style, validate=None
        )
    ...
    def test_prompt_password(self, mock_password):
        ...
        mock_password.assert_called_once_with(
            "Enter password::", style=ui.style, validate=None
        )
    ...
    def test_select(self, mock_select):
        ...
        mock_select.assert_called_once_with(
            "Choose option:", choices=choices, default="Option 1", style=ui.style
        )
    ...
    def test_select_with_dict_choices(self, mock_select):
        ...
        choices = [
            {"name": "Choice 1", "value": "val1"},
            {"name": "Choice 2", "value": "val2"},
        ]
        ...
        mock_select.assert_called_once_with(
            "Choose option:", choices=expected_choices, default=None, style=ui.style
        )
    ...
    def test_multiselect(self, mock_checkbox):
        ...
        mock_checkbox.assert_called_once_with(
            "Choose options:", choices=choices, style=ui.style
        )
